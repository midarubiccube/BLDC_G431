...
void init_timer(void) {
	...
	__HAL_TIM_SET_COMPARE (&htim1, TIM_CHANNEL_1, 0.5f * PWM_PERIOD_COUNTS);
	__HAL_TIM_SET_COMPARE (&htim1, TIM_CHANNEL_2, 0.5f * PWM_PERIOD_COUNTS);
	__HAL_TIM_SET_COMPARE (&htim1, TIM_CHANNEL_4, 0.5f * PWM_PERIOD_COUNTS +  100);
	HAL_Delay(10); // 0.1秒待機
	__HAL_TIM_SET_COMPARE (&htim1, TIM_CHANNEL_1, 0.5f * PWM_PERIOD_COUNTS);
	__HAL_TIM_SET_COMPARE (&htim1, TIM_CHANNEL_2, 0.5f * PWM_PERIOD_COUNTS);
